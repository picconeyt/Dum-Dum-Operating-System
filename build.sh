...
gcc -m32 -march=i386 -ffreestanding -fno-PIE -nostdlib -c locale.c -o locale.o
...
ld -m elf_i386 -Ttext 0x7E00 --oformat binary -e start kernel.o datest.o locale.o fat.o -o kernel.bin
